...
public class Attributes
{
    ...
    public void Add(string key, string value)
    {
        ...
        if (isNotAllowed)
        {
            ...
            throw new HtmlDocumentBuilderException(HtmlDocumentBuilderErrorCode.AttributeNotAllowed,
                $"Adding this attribute is not allowed, {info}");
        }

        if (shouldBeUnique && containsKey)
        {
            throw new HtmlDocumentBuilderException(HtmlDocumentBuilderErrorCode.AttemptedToAddDuplicateUniqueHtmlAttribute,
