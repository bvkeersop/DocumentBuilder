...
{
    [TestClass]
    public class OrderedListTests : TestBase
    {
        ...
        private string CreateExpectedMarkdownOrderedList()
        {
            ...
            return
                $"1. {string1}" + _newLineProvider.GetNewLine() +
                $"1. {string2}" + _newLineProvider.GetNewLine() +
                $"1. {string3}" + _newLineProvider.GetNewLine();
        }
        ...
        private string CreateExpectedHtmlOrderedList()
        {
            ...
            return
                "<ol>" + _newLineProvider.GetNewLine() + _indentationProvider.GetIndentation(1) +
                ...
                "</ol>" + _newLineProvider.GetNewLine();
        }
    }
}
